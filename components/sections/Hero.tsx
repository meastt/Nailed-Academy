    ...
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <Image
          ...
          fill
          className="object-cover opacity-30 hero-ken-burns"
          priority
        />
        {/* Single subtle gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-matte-black/60 via-matte-black/40 to-matte-black/70" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        {/* Dark container box for text content */}
        <div className="hero-animate-2 inline-block max-w-4xl mx-auto px-8 py-12 md:px-16 md:py-16 rounded-lg backdrop-blur-md bg-matte-black/80 border border-champagne-gold/20 shadow-2xl">
          {/* Location badge */}
          <div className="hero-animate-1 mb-6">
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-champagne-gold/30 bg-matte-black/60 backdrop-blur-sm text-xs tracking-[0.2em] uppercase text-champagne-gold/80">
          ...
          {/* Tagline */}
          <p className="hero-animate-3 text-lg md:text-xl text-foreground/90 mb-10 max-w-xl mx-auto font-light tracking-wide">
